...
const AddScreenToGroupModal = ({ visible, onClose}) => {

    const toggleModal = (e) => {
        if (e.target.id === 'AddScreenToGroupModal') onClose();
    };
            ...
            <div className="h-auto p-4 bg-white rounded-lg xs:mx-3 md:w-2/3 w-full ">
                ...
                <div className=''>
                    <div className='flex flex-row justify-between items-center border-b-2 border-gray-200 pb-4'>
                        <p className='font-bold text-xl md:text-2xl'>Add Screens</p>
                        <div 
                        onClick={(e) => {
                            e.stopPropagation();
                            onClose();}}
...
export default AddScreenToGroupModal;
